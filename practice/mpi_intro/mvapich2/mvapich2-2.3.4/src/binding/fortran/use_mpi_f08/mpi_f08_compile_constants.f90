...
type(MPI_Datatype), parameter   :: MPI_REAL16          = MPI_Datatype(1275072555)
type(MPI_Datatype), parameter   :: MPI_COMPLEX8        = MPI_Datatype(1275070504)
type(MPI_Datatype), parameter   :: MPI_COMPLEX16       = MPI_Datatype(1275072554)
type(MPI_Datatype), parameter   :: MPI_COMPLEX32       = MPI_Datatype(1275076652)
